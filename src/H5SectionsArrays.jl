...
"""
function H5SectionsArray(fregister::AbstractString)
    if isdir( fregister )
    ...
    H5SectionsArray(register)
end

"""
get the section file name of the z coordinate
"""
function get_section_filename( ba::H5SectionsArray, z::Int )
...
number of dimension
"""
function Base.ndims(A::H5SectionsArray)
...
"""
function boundingbox(A::H5SectionsArray; zmin=-Inf, zmax =Inf)
    x1 = Inf;   x2 = -Inf;
    y1 = Inf;   y2 = -Inf;
    z1 = Inf;   z2 = -Inf;
...
"""
function Base.size(A::H5SectionsArray)
    bb = boundingbox(A)
    map(length, bb)
end

function Base.size(A::H5SectionsArray, i::Int)
    size(A)[i]
end

function Base.show(A::H5SectionsArray)
...
function Base.getindex(A::H5SectionsArray, r::CartesianRange)
...
"""
function Base.getindex(A::H5SectionsArray, idxes::Union{UnitRange, Int}...)
...
function Base.CartesianRange( ba::H5SectionsArray, z::Int )
    d = ba.register[z]
